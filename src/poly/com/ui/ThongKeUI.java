...
//        lblTongSVPM.setText("Tổng Sinh Viên mượn Sách [ "+cboSachPM.getSelectedItem().toString()+ " ] là: " + String.valueOf(tongso));
    ...
    private void initComponents() {
        ...
        cboSapXepPM.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tất cả", "Phiếu Mượn còn hạn trả sách", "Phiếu Mượn quá hạn trả sách", "Sách mượn nhiều nhất", "Sách mượn ít nhất" }));
